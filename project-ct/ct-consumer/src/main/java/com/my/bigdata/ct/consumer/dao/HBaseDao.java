package com.my.bigdata.ct.consumer.dao;

import com.my.bigdata.ct.common.bean.BaseDao;
import com.my.bigdata.ct.common.constant.Names;
import com.my.bigdata.ct.common.constant.ValueConstant;
import com.my.bigdata.ct.consumer.bean.Calllog;
...
public class HBaseDao extends BaseDao {
    ...
    public void init() throws Exception {
        ...
        createTableXX(Names.TABLE.getValue(), "com.my.bigdata.ct.consumer.coprocessor.InsertCalleeCoprocessor", ValueConstant.REGION_COUNT, Names.CF_CALLER.getValue(), Names.CF_CALLEE.getValue());
